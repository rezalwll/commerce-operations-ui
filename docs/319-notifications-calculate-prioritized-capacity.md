...
This note records the decision behind **notifications** behavior in commerce-operations-ui.
...
Use a small, independently testable function for the prioritized path. Keep input normalization at the boundary and return a neutral value for missing samples.
...
Review marker: decision 319 in the project evolution.
