...
This note records the decision behind **fulfillment** behavior in commerce-operations-ui.
...
Use a small, independently testable function for the responsive path. Keep input normalization at the boundary and return a neutral value for missing samples.
...
Review marker: decision 332 in the project evolution.
