...
This note records the decision behind **inventory** behavior in commerce-operations-ui.
...
Use a small, independently testable function for the localized path. Keep input normalization at the boundary and return a neutral value for missing samples.
...
Review marker: decision 95 in the project evolution.
